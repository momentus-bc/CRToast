...
NSString *const kCRToastCloseButtonKey                      = @"kCRToastCloseButtonKey";
...
static BOOL                          kCRToastShowCloseButtonDefault         = NO;
...
+ (void)initialize {
    if (self == [CRToast class]) {
        ...
        kCRToastKeyClassMap = @{kCRToastNotificationTypeKey                 : NSStringFromClass([@(kCRNotificationTypeDefault) class]),
                                ...
                                kCRToastCloseButtonKey                      : NSStringFromClass([@(kCRToastShowCloseButtonDefault) class]),
...
+ (void)setDefaultOptions:(NSDictionary*)defaultOptions {
    ...
    if (defaultOptions[kCRToastCloseButtonKey])                     kCRToastShowCloseButtonDefault          = [defaultOptions[kCRToastCloseButtonKey] boolValue];
...
- (BOOL)showCloseButton {
    return _options[kCRToastCloseButtonKey] ?
    [self.options[kCRToastCloseButtonKey] boolValue] :
    kCRToastShowCloseButtonDefault;
}
